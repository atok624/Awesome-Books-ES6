...
class IANAZone extends Zone {
  ...
  /**
   * Returns whether the provided string is a valid specifier. This only checks the string's format,
   * not that the specifier identifies a known zone; see isValidZone for that.
